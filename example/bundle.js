...
exports.SVGTS = exports.SVGTSPolyline = void 0;
var uuid_1 = require("uuid");
var SVGTSPolyline = /** @class */ (function () {
    function SVGTSPolyline(svgDoc, onClickCb) {
        var _this = this;
        this.points = [];
        this.svgDoc = svgDoc;
        this.polylineElement = document.createElementNS("http://www.w3.org/2000/svg", "polyline");
        this.polylineElement.id = uuid_1.v4();
        this.polylineElement.addEventListener('click', function () {
            onClickCb(_this.polylineElement.id);
        });
        this.svgDoc.appendChild(this.polylineElement);
        this.stroke();
    }
    Object.defineProperty(SVGTSPolyline.prototype, "Id", {
        get: function () {
    ...
    SVGTSPolyline.prototype.draw = function (points) {
        this.points = points;
        this.polylineElement.setAttributeNS(null, "points", this.points.map(function (p) { return p[0] + "," + p[1]; }).join(" "));
    };
    SVGTSPolyline.prototype.extend = function (x, y) {
        this.points.push([x, y]);
        this.draw(this.points);
    };
    SVGTSPolyline.prototype.stroke = function (width, color) {
    ...
    return SVGTSPolyline;
}());
exports.SVGTSPolyline = SVGTSPolyline;
var SVGTS = /** @class */ (function () {
    function SVGTS(container, clickCb, size) {
        if (size === void 0) { size = { width: "100%", height: "100%" }; }
    ...
    SVGTS.prototype.handlePolylineClicked = function (clickedLineId) {
        this.clickCb(clickedLineId);
    };
    SVGTS.prototype.createPolyline = function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
__exportStar(require("./SVGTS"), exports);

},{"./SVGTS":1}],3:[function(require,module,exports){
"use strict";
...
},{"./nil.js":6,"./parse.js":7,"./stringify.js":11,"./v1.js":12,"./v3.js":13,"./v4.js":15,"./v5.js":16,"./validate.js":17,"./version.js":18}],5:[function(require,module,exports){
"use strict";
...
var _default = v3;
exports.default = _default;
},{"./md5.js":5,"./v35.js":14}],14:[function(require,module,exports){
"use strict";
...
var _default = v4;
exports.default = _default;
},{"./rng.js":9,"./stringify.js":11}],16:[function(require,module,exports){
"use strict";
